...
\begin{frame}{}
  \mbox{}\vspace{-0.15cm}
  {\Large\bfseries\color{navy}Where I did not believe the AI\par}
  \vspace{0.25cm}
  \textbf{Claim to test}
...
\begin{frame}{Hand check: sign condition and numerical threshold}
  \centering
  \IfFileExists{hand/wage-derivation.jpg}{%
    \includegraphics[viewport=0 1378 1940 2756,clip,width=0.48\textwidth]{hand/wage-derivation.jpg}%
    \hfill
    \includegraphics[viewport=0 0 1940 1378,clip,width=0.48\textwidth]{hand/wage-derivation.jpg}%
  }{%
    \colorbox{sand}{\parbox{0.95\textwidth}{\centering Owner-supplied photograph required.}}%
  }
  \source{Owner's handwritten derivation of Proposition 3}
\end{frame}
